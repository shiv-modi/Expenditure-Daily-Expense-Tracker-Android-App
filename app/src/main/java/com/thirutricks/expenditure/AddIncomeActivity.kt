...
import com.thirutricks.expenditure.databinding.ActivityAddIncomeBinding
        ...
        RetrofitClient.instance.getCategories(null).enqueue(object : Callback<CategoryResponse> {
            override fun onResponse(call: Call<CategoryResponse>, response: Response<CategoryResponse>) {
                if (response.isSuccessful && response.body() != null) {
                    ...
                    val allCategories = catResponse.categories ?: emptyList() // Handle null
                    
                    categories = allCategories.filter { it.mode.equals("Income", ignoreCase = true) }
                    
                    // Fallback: If no income categories found, show all (or empty if none)
            ...
            override fun onFailure(call: Call<CategoryResponse>, t: Throwable) {
                Toast.makeText(this@AddIncomeActivity, "Error: ${t.message}", Toast.LENGTH_SHORT).show()
            }
        })
    }
